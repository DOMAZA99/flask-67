...
#For form
app.config['SECRET_KEY'] = 'shdbviwjvbsdjkvnsksdvsbsxcsdvsvwlkmlbkjvsjkdvsjdk'
...
def store():
    if request.method == "POST":
        ...
        sql = "INSERT INTO flowers (flower_name, lat_num, long_num, place, detail)VALUE (%s,%s,%s,%s,%s)"
